...
const CATEGORY_FIELDS = {
  ...
  Printer: [
    ...
    {
      field_name: "is_color",
      field_label: "Color Printing",
      field_type: "boolean",
      sort_order: 2,
    },
    {
      field_name: "is_network",
      field_label: "Network Printer",
      field_type: "boolean",
      sort_order: 3,
    },
  ],
  UPS: [
    {
      field_name: "capacity_va",
      field_label: "Capacity (VA)",
      field_type: "number",
      sort_order: 1,
    },
    {
      field_name: "battery_type",
      field_label: "Battery Type",
      field_type: "text",
      sort_order: 2,
    },
  ],
...
async function run() {
  ...
  try {
    ...
    console.log("  3. Visit:               http://localhost:5174/setup");
