...
const EmployeeDetailDrawer = ({ employee, isOpen, onClose, onUpdate }) => {
  ...
  const { data: activeConsumables } = useQuery({
    queryKey: ["employee-consumable-assignments", employee?.id, "active"],
    queryFn: () =>
      consumableApi
        .getAssignments({
    ...
    { key: "assigned_at", header: "Assigned", render: (v) => formatDate(v) },
    {
      ...
      render: (v) =>
        v ? (
          ...
          <span className="text-indigo-600 font-medium text-xs">Active</span>
        ),
    },
    {
  ...
  const returnableConsumableCount = (activeConsumables || []).filter(
    (a) => a.is_returnable
  ).length;
  ...
  return (
    <>
          ...
          <>
            ...
            <div className="flex gap-2 flex-wrap justify-end">
                ...
                <Button
                  ...
                  title={
                    hasActiveAssignments
                      ? `Return ${totalActiveCount} item(s) before archiving`
                      : "Archive employee"
                  }
              ...
              <Button
                ...
                title={
                  employee.is_archived
                    ? "Cannot assign assets to an archived employee"
                    : "Create a new asset and assign it directly"
                }
              >
                🖥️ Create &amp; Assign
              </Button>
      ...
      >
        ...
        {/* Equipment tab */}
        {tab === "equipment" && <EmployeeEquipmentTab employee={employee} />}
